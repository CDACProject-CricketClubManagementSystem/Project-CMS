...
public class UserController {
    ...
    public ResponseEntity<?> createUser(@RequestBody CreateUserDTO createUserDTO) {
    	 ...
    	 String message = "User " + createUserDTO.getUsername() + " has applied to be a "+createUserDTO.getRole();
         notificationService.createNotification(createUserDTO.getUsername(), message);
